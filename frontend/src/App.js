            ...
            <div>
                ...
                <BrowserRouter>
                    ...
                    <Routes>
                        ...
                        <Route exact path='/projects' element={<ProjectsList projects={this.state.projects} delete_project={(id) => this.delete_project(id)}/>}/>
                        <Route exact path='/todo' element={<ToDosList todos={this.state.todos} delete_todo={(id) => this.delete_todo(id)}/>}/>
