"""
Django settings for ToDo_planner project.
...
SECRET_KEY = 'django-insecure-@sun2tpkoak416t63f-_7*fgu@z^4c-39x*am1b0#ibfc1+p@4'
...
ROOT_URLCONF = 'ToDo_planner.urls'
...
WSGI_APPLICATION = 'ToDo_planner.wsgi.application'
